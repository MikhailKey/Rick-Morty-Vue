...
export { 
//getters
CHARACTERS, ERROR, FAVOURITES_IDS, LOADING, PAGE, PAGES_COUNT, SEARCH_VALUE, SPECIES, FAVOURITES, CHARACTER, 
//actions,
ADD_TO_FAVOURITES, GET_CHARACTERS, GET_PAGE, GET_SEARCH_VALUE, GET_SPECIES, GET_URL_PARAMS, REMOVE_FROM_FAVOURITES, GET_FAVOURITES_IDS, GET_FAVOURITES, GET_CHARACTER, 
//mutations
CHANGE_ERROR, CHANGE_LOADING, FILTER_FAVOURITES, UPDATE_CHARACTERS, UPDATE_FAVOURITES, UPDATE_PAGE, UPDATE_PAGES_COUNT, UPDATE_SEARCH_VALUE, UPDATE_SPECIES, UPDATE_URL_PARAMS, UPDATE_FAVOURITES_FROM_STORE, LOAD_FAVOURITES_LIST, UPDATE_CHARACTER, };
